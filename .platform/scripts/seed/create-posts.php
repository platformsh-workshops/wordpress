...
$pttrnPostCreate='wp post create --post_title="%s" --post_content="%s" --post_status=publish --porcelain --path="wordpress"';
//command for creating media
$pttrnImgCreate='wp media import "%s" --title="%s" --alt="%s" --caption="%s" --post_id=%d --featured_image --path="wordpress"';
